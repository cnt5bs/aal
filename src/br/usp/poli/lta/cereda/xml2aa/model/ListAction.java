...
/**
 * Define uma ação adaptativa baseada em uma especificação
 * de lista XML.
 *
...
public class ListAction extends Action {
     ...
     * @param xml Especificação XML da ação adaptativa do
     * autômato.
     */
    ...
    /**
     * Define o contador do método gerador de novos estados,
     * de acordo com o valor máximo dos estados do autômato
     * adaptativo.
     *
    ...
    /**
     * Faz a ligação dos parâmetros da função adaptativa,
     * das variáveis e dos geradores.
     *
    ...
    /**
     * Verifica qual categoria de ação elementar executar,
     * de acordo com o número de parâmetros fornecidos na
     * especificação XML da ação.
     *
     ...
     *
     * @param action Especificação XML da ação adaptativa
     * elementar.
    ...
    /**
     * Resolve a ação de acordo o nome da ação e a lista de
     * parâmetros.
     *
