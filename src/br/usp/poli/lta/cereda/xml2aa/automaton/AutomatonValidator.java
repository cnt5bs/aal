...
public class AutomatonValidator {
     ...
     * Construtor.
     *
     * @param automaton Especificação XML do autômato
     * adaptativo.
     */
    ...
    /**
     * Faz a validação da especificação XML do autômato
     * adaptativo.
     *
     * @throws AutomatonSpecException A especificação é
     * inválida.
     */
    ...
    /**
     * Método utilitário para lançar exceções de
     * especificação.
     *
     * @param message Mensagem da exceção.
     * @throws AutomatonSpecException Exceção parametrizada
     * com a mensagem.
     */
    ...
    /**
     * Verifica se o autômato adaptativo possui transições
     * associadas.
     *
    ...
    /**
     * Verifica se toda transição tem estados de origem e
     * destino.
     *
     * @throws AutomatonSpecException Há transições com
     * problemas.
     */
    ...
    /**
     * Verifica se o autômato adaptativo possui estados
     * inteiros.
     *
    ...
    /**
     * Verifica se o autômato adaptativo possui chamadas de
     * ações adaptativas.
     *
     * @throws AutomatonSpecException Estas existem e são
     * inválidas.
     */
    ...
    /**
     * Verifica as ações adaptativas do autômato, se
     * existirem.
     *
     * @throws AutomatonSpecException As ações adaptativas
     * são inválidas.
     */
    ...
    /**
     * Retorna o singular ou plural da palavra, de acordo
     * com o valor inteiro.
     *
    ...
    /**
     * Verifica se o autômato possui chamadas válidas de
     * submáquina.
     *
     * @throws AutomatonSpecException Existem chamadas
     * inválidas.
     */
    ...
    /**
     * Verifica se o autômato possui transições com consumo
     * de símbolo válidas.
     *
     * @throws AutomatonSpecException Existem transições com
     * consumo de símbolo inválidas.
     */
