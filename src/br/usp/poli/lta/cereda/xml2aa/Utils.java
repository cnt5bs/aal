...
public class Utils {
    ...
    /**
     * Analisa os argumentos de linha de comando, retornano
     * o arquivo referente à analise ou lançando exceções de
     * acordo com o tipo de erro encontrado.
     *
     * @param args Argumentos de linha de comando.
     * @return Arquivo XML referente à analise.
     * @throws Exception Os argumentos são inválidos ou o
     * arquivo não existe.
     */
    ...
    /**
     * Retorna uma lista de símbolos a partir de uma cadeia
     * de símbolos.
     *
