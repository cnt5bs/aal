...
/**
 * Esta classe define o conjunto de submáquinas do autômato
 * adaptativo.
 *
...
public class SubmachinesSet {
    ...
    /**
     * Adiciona uma nova submáquina ao conjunto de
     * submáquinas.
     *
    ...
    /**
     * Retorna a cardinalidade do conjunto de todas as
     * submáquinas.
     *
     * @return Valor inteiro representando a cardinalidade
     * do conjunto de todas as submáquinas do autômato
     * adaptativo.
     */
    public int size() {
    ...
    /**
     * Obtém a submáquina que contém o estado informado. De
     * acordo com a teoria, os conjuntos das submáquinas são
     * disjuntos entre si.
     *
    ...
    /**
     * Remove a submáquina do conjunto de submáquinas, de
     * acordo com o nome informado.
     *
     * @param name Nome da submáquina a ser removida do
     * conjunto de submáquinas.
     */
