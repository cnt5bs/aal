...
/**
 * Classe que representa uma ação no autômato adaptativo.
 * Uma ação pode conter ações adaptativas elementares e
 * ações de caráter semântico, de acordo com a implementação
 * do método abstrato da classe.
 *
...
public abstract class Action {
     ...
     *
     * @return Valor inteiro que representa o identificador
     * unívoco da ação.
     */
     ...
     *
     * @param identifier Valor inteiro que representa o
     * identificador unívoco da ação.
     */
    ...
    /**
     * Executa a ação. É possível utilizar ações adaptativas
     * elementares e de caráter semântico no corpo do
     * método. Este método está definido como abstrato.
     *
     * @param transitions Conjunto de transições do autômato
     * adaptativo.
     * @param transition Transição corrente, servindo como
     * referência.
