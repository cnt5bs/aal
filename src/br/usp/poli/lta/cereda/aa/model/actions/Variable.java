...
/**
 * Representa uma variável de consulta nas ações
 * elementares. Cada variável possui um conjunto de valores.
 *
...
public class Variable {
    ...
    /**
     * Verifica se a variável está disponível para
     * preencimento.
     *
     * @return Valor lógico indicando se a variável está
    ...
    /**
     * Retorna um vetor de objetos. Este método estático é
     * utilizado somente para facilitar a especificação de
     * um vetor de objetos.
     *
