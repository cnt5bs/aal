...
/**
 * Define a estrutura de dados de pilha para ser utilizada
 * pelo autômato adaptativo. A pilha, neste caso, permite
 * apenas a manipulação de elementos que estão no topo.
 *
...
public class Stack {
     ...
     *
     * @param entry Estado a ser adicionado no topo da
     * pilha.
     */
    ...
    /**
     * Retorna o estado que está no topo da pilha, sem,
     * entretanto, removê-lo.
     *
     ...
     *
     * @return Valor lógico que informa se a pilha está
     * vazia.
     */
