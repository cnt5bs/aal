...
/**
 * Classe que representa uma transição da relação de
 * mapeamento do autômato adaptativo. Uma transição pode ser
 * de quatro tipos distintos: consumo de símbolo, transição
 * em vazio, chamada de submáquina e retorno de submáquina.
 * Cada transição pode ter duas ações associadas: uma antes
 * e outra depois da execução da transição propriamente
 * dita.
 *
...
public class Transition {
    ...
    /**
     * Construtor. Obtém o identificador unívoco da
     * transição corrente e inicializa todas as variáveis
     * apontando para nulo.
     */
    public Transition() {
     ...
     *
     * @return Valor inteiro representando o identificador
     * unívoco da transição corrente.
     */
     ...
     *
     * @param identifier Valor inteiro representando o
     * identificador unívoco da transição corrente.
     */
     ...
     *
     * @param submachineCall Nome da submáquina a ser
     * chamada.
     */
     ...
     *
     * @return Vetor de objetos contendo os parâmetros da
     * ação anterior.
     */
     ...
     *
     * @param priorActionArguments Vetor de objetos contendo
     * os parâmetros da ação anterior.
     */
     ...
     *
     * @param postActionArguments Vetor de objetos contendo
     * os parâmetros da ação posterior.
     */
    ...
    /**
     * Define uma transição convencional com consumo de
     * símbolo ou em vazio.
     *
     * @param sourceState Estado de origem.
     * @param symbol Símbolo a ser consumido, ou nulo
     * representando transição em vazio.
     * @param targetState Estado de destino.
     */
     ...
     * @param submachineCall Nome da submáquina a ser
     * chamada.
     * @param targetState Estado de retorno quando a
     * submáquina que foi chamada encerrar-se.
     */
    ...
    /**
     * Informa se a transição corrente é uma chamada de
     * submáquina.
     *
     * @return Valor lógico informando se a transição
     * corrente é uma chamada de submáquina.
     */
    ...
    /**
     * Informa se a transição corrente é uma transição
     * comum, isto é, que não é uma chamada de de
     * submáquina.
     *
     * @return Valor lógico informando se a transição
     * corrente é comum.
    ...
    /**
     * Informa se a transição corrente é de consumo de
     * símbolo.
     *
     * @return Valor lógico informando se a transição é de
     * consumo de símbolo.
     */
     ...
     *
     * @return Valor lógico informando se a transição tem
     * ação anterior.
     */
    ...
    /**
     * Informa se a transição corrente é um retorno de
     * submáquina. Este tipo de transição é usado
     * internamente pelo modelo.
     *
     * @return Valor lógico informando se a transição
     * corrente é um retorno de submáquina.
     */
    ...
    /**
     * Define se a transição corrente é um retorno de
     * submáquina.
     *
     * @param submachineReturn Valor lógico informando se a
     * transição corrente é um retorno de submáquina.
     */
    ...
    /**
     * Fornece uma representação textual da transição
     * corrente.
     *
    ...
    /**
     * Retorna uma representação textual do vetor de objetos
     * referente aos parâmetros de uma ação.
     *
    ...
    /**
     * Retorna uma representação textual do valor lógico
     * informado.
     *
    ...
    /**
     * Verifica se a ação anterior tem argumentos. Este
     * método verifica se a transição tem ação anterior
     * antes de verificar seus argumentos.
     *
     * @return Valor lógico que denota se a ação anterior
     * tem argumentos.
     */
    ...
    /**
     * Verifica se a ação posterior tem argumentos. Este
     * método verifica se a transição tem ação posterior
     * antes de verificar seus argumentos.
     *
     * @return Valor lógico que denota se a ação posterior
     * tem argumentos.
     */
     ...
     *
     * @return Um valor inteiro denotando o número de
     * argumentos da ação anterior. Um valor negativo indica
     ...
     *
     * @return Um valor inteiro denotando o número de
     * argumentos da ação posterior. Um valor negativo
     * indica que não há argumentos.
     */
