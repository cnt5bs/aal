...
public class ActionQuery {
     ...
     *
     * @param name Variável que denota o nome da ação.
     * @param parameters Lista de variáveis representando os
     * parâmetros da ação consultada.
     */
    ...
    /**
     * Obtém uma lista de variáveis que denota a lista de
     * argumentos da ação.
     *
     * @return Lista de variáveis que denota a lista de
     * argumentos da ação.
     */
    ...
    /**
     * Verifica se a consulta da ação tem argumentos
     * definidos.
     *
     * @return Valor lógico denotando se a consulta da ação
     * tem argumentos definidos.
     */
    ...
    /**
     * Fornece uma representação textual da consulta de
     * ação.
     *
