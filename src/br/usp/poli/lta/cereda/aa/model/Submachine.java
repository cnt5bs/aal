...
/**
 * Classe que representa a definição formal de uma
 * submáquina. A intenção é tentar representar a teoria da
...
public class Submachine {
    ...
    /**
     * Construtor. Define a estrutura da submáquina como um
     * todo.
     *
     * @param name Nome da submáquina.
     * @param states Conjunto de todos os estados da
     * submáquina.
     * @param initialState Estado inicial ou de entrada da
     * submáquina.
     * @param acceptingStates Conjunto de estados finais ou
     * de aceitação.
     */
     ...
     *
     * @return Um valor inteiro que representa o
     * identificador da submáquina.
     */
     ...
     *
     * @param identifier Um valor inteiro que representa o
     * identificador da submáquina.
     */
    ...
    /**
     * Obtém todos os estados de aceitação ou de saída da
     * submáquina.
     *
     * @return Um conjunto contendo os estados de aceitação
     * ou de saída da submáquina.
     */
    ...
    /**
     * Define o conjunto de estados finais ou de aceitação
     * da submáquina.
     *
     * @param acceptingStates Conjunto de estados finais da
     * submáquina.
     */
    ...
    /**
     * Retorna uma representação textual da submáquina
     * corrente.
     *
