...
/**
 * Implementa o autômato adaptativo propriamente dito. Esta
 * classe é definida como abstrata, forçando a redefinição
 * do método de especificação das transições, submáquinas e
 * ações.
 *
...
public abstract class AdaptiveAutomaton {
    ...
    /**
     * Define a configuração inicial do autômato adaptativo.
     * Este método é abstrato e deverá ser implementado.
     */
    ...
    /**
     * Obtém, apenas uma vez, o mapa contendo os caminhos de
     * reconhecimento.
     *
     * @return Mapa contendo os caminhos de reconhecimento.
     */
    ...
    /**
     * Obtém a lista contendo todos os caminhos de
     * reconhecimento obtidos durante a execução do autômato
     * adaptativo.
     *
    ...
    /**
     * Obtém, apenas uma vez, a lista contendo todos os
     * caminhos de reconhecimento obtidos durante a execução
    ...
    /**
     * Reconhece, apenas uma vez, uma lista de símbolos
     * representado a cadeia de entrada.
     *
     * @param input Lista de símbolos representando a cadeia
     * de entrada.
     * @return Um valor lógico informando se o autômato
    ...
    /**
     * Verifica se, pelo menos, um caminho de reconhecimento
     * encerrou-se.
     *
     * @return Um valor lógico que denota se, pelo menos, um
     * caminho de reconhecimento já encerrou-se.
     */
    ...
    /**
     * Retorna uma representação textual do autômato
     * adaptativo.
     *
    ...
    /**
     * Define a condição de parada do autômato adaptativo
     * tal que este não prossiga após o resultado de, pelo
     * menos, um caminho de reconhecimento.
     *
     * @param flag Valor lógico que determina se o autômato
     * deve continuar o reconhecimento mesmo que já tenha um
