...
/**
 * Realiza o passo computacional do autômato adaptativo. É
 * importante destacar que uma thread só é executada uma
 * única vez.
 *
...
public class Kernel extends Thread {
     ...
     * @param removals Lista de identificadores para
     * remoção.
    ...
    /**
     * Obtém o conjunto de transições do autômato
     * adaptativo.
     *
     * @return Conjunto de transições do autômato
     * adaptativo.
     */
    ...
    /**
     * Obtém o conjunto de submáquinas do autômato
     * adaptativo.
     *
     * @return Conjunto de submáquinas do autômato
     * adaptativo.
     */
     ...
     *
     * @return Valor lógico indicando se a ação anterior
     * está habilitada.
     */
    ...
    /**
     * Obtém a lista de identificadores para remoção de
     * threads.
     *
     * @return Lista de identificadores para remoção de
     * threads.
     */
     ...
     *
     * @param actions Conjunto de ações do autômato
     * adaptativo.
     */
    ...
    /**
     * Define o conjunto de transições do autômato
     * adaptativo.
     *
     * @param transitions Conjunto de transições do autômato
     * adaptativo.
     */
    ...
    /**
     * Define o conjunto de submáquinas do autômato
     * adaptativo.
     *
     * @param submachines Conjunto de submáquinas do
     * autômato adaptativo.
     */
    ...
    /**
     * Define a lista de símbolos representando a cadeia de
     * entrada.
     *
     * @param input Lista de símbolos representando a cadeia
     * de entrada.
     */
     ...
     *
     * @param cursor Valor inteiro representando a posição
     * do cursor.
     */
     ...
     *
     * @param enablePriorAction Valor lógico indicando se a
     * ação anterior está habilitada.
     */
    ...
    /**
     * Define a lista de identificadores para remoção de
     * threads.
     *
    ...
    /**
     * Executa a ação da thread, que representa um passo
     * computacional do autômato adaptativo. Após a execução
     * deste método, a thread encerra-se.
     */
    @Override
    public void run() {
     ...
     * @return Valor lógico indicando se a consulta tem
     * chamadas de submáquina.
     */
    ...
    /**
     * Obtém as transições que possuem chamadas de
     * submáquina a partir da consulta corrente.
     *
     * @param query Consulta.
    ...
    /**
     * Verifica se a consulta tem transições de consumo de
     * símbolo.
     *
     * @param query Consulta.
     * @return Valor lógico indicando se a consulta tem
     * transições de consumo de símbolo.
     */
    ...
    /**
     * Obtém as transições com consumo de símbolo a partir
     * da consulta corrente.
     *
     * @param query Consulta.
     * @return Lista de transições.
     */
    ...
    /**
     * Obtém as transições em vazio a partir da consulta
     * corrente.
     *
     * @param query Consulta.
     * @return Lista de transições.
