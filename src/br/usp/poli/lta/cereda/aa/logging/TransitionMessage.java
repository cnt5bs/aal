...
/**
 * Define uma mensagem com a expansão de transição para ser
 * auditada.
 *
...
public class TransitionMessage implements Message {
    ...
    /**
     * Construtor. Toma a transição, uma mensagem e seus
     * parâmetros.
     *
     * @param t Transição.
     * @param m Mensagem.
    ...
    /**
     * Obtém a mensagem formatada. Se esta possui
     * parâmetros, eles serão devidamente expandidos.
     *
     * @return A mensagem formatada para ser auditada, com
     * referência à transição.
     */
    @Override
