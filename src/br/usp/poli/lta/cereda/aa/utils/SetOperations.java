...
/**
 * Classe utilitária que fornece algumas operações entre
 * conjuntos.
 *
...
public class SetOperations {
    ...
    /**
     * Obtém, de forma recursiva, o produto cartesiano de um
     * vetor de conjuntos de acordo com o índice fornecido,
     * em ordem reversa.
     *
     * @param index Índice fornecido.
     * @param sets Vetor de conjuntos.
     * @return Produto cartesiano do vetor de conjuntos de
     * acordo com o índice fornecido, em ordem reversa.
     */
    ...
    /**
     * Calcula o produto cartesiano de um vetor de
     * conjuntos.
     *
     * @param sets Vetor de conjuntos.
