...
/**
 * Gera identificadores unívocos para representar
 * submáquinas, caminhos de reconhecimento, ações,
 * transições e threads de execução. Todos os métodos dessa
 * classe são estáticos, portanto a classe não deve ser
 * instanciada na forma de um objeto.
 *
...
public class IdentifierUtils {
     ...
     *
     * @return Um valor inteiro representando um novo
     * identificador unívoco de uma submáquina.
     */
    ...
    /**
     * Obtém um novo identificador de caminho de
     * reconhecimento.
     *
     * @return Um valor inteiro representando um novo
     * identificador unívoco de um caminho de
     * reconhecimento.
     */
     ...
     *
     * @return Um valor inteiro representando um novo
     * identificador unívoco de uma determinada ação.
     */
    ...
    /**
     * Obtém um novo identificador de thread de
     * reconhecimento.
     *
     * @return Um valor inteiro representando um novo
     * identificador unívoco de uma thread de
     * reconhecimento.
     */
